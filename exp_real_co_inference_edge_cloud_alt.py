...
def sendDistortedImage(data, target, nr_branch_edge, p_tar, distortion_lvl, distortion_type):
	sendImage(config.url_e, data, target, nr_branch_edge, p_tar, distortion_type, distortion_lvl)
	sendImage(config.url_ensemble, data, target, nr_branch_edge, p_tar, distortion_type, distortion_lvl)
